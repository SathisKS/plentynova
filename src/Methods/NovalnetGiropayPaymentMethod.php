...
class NovalnetGiropayPaymentMethod extends PaymentMethodService
{
    ...
    {   
        return $this->paymentHelper->getCustomizedTranslatedText('paymentmethod_novalnet_giropay');
    }
    ...
    {
        return $this->paymentHelper->getCustomizedTranslatedText('paymentmethod_novalnet_giropay_payment_description');
    }
