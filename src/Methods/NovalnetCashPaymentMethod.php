...
class NovalnetCashPaymentMethod extends PaymentMethodService
{
        ...
        public function isActive():bool
    {
       if ($this->configRepository->get('Novalnet.novalnet_cashpayment_payment_active') == 'true') {
        ...
        $minimum_amount = trim($this->configRepository->get('Novalnet.novalnet_cashpayment_minimum_order_amount'));
        ...
        $maximum_amount = trim($this->configRepository->get('Novalnet.novalnet_cashpayment_maximum_order_amount'));
    ...
    {   
        $description = trim($this->configRepository->get('Novalnet.novalnet_cashpayment_description'));
        return ($description ? $description : $this->paymentHelper->getTranslatedText('cashpayment_payment_description'));
    }
