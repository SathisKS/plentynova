...
class NovalnetCcPaymentMethod extends PaymentMethodService
{
    ...
    {   
        return $this->paymentHelper->getCustomizedTranslatedText('paymentmethod_novalnet_cc');
    }
    ...
    {
         return $this->paymentHelper->getCustomizedTranslatedText('paymentmethod_novalnet_cc_payment_description');
    }
