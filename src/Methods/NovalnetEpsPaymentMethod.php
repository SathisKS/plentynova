...
class NovalnetEpsPaymentMethod extends PaymentMethodService
{
        ...
        public function isActive():bool
    {
       if ($this->configRepository->get('Novalnet.novalnet_eps_payment_active') == 'true') {
        ...
        $minimum_amount = trim($this->configRepository->get('Novalnet.novalnet_eps_minimum_order_amount'));
        ...
        $maximum_amount = trim($this->configRepository->get('Novalnet.novalnet_eps_maximum_order_amount'));
    ...
    {
        $logoUrl = $this->configRepository->get('Novalnet.novalnet_eps_payment_logo');
        if($logoUrl == 'images/eps.png'){
            /** @var Application $app */
            $app = pluginApp(Application::class);
            $logoUrl = $app->getUrlPath('novalnet') .'/images/eps.png';
        } 
        return $logoUrl;
    }
    ...
    {
        return $this->paymentHelper->getCustomizedTranslatedText('paymentmethod_novalnet_eps_payment_description');
    }
